$(document).ready(function() {
	...
	console.log(id_text)
      ...
      function add_to_cart(item, id_text) {
        ...
        const url = 'http://localhost:5001/api/v1/carts/2603b922-3fd5-4b0f-aa44-bd4cf20491e2/cart_items';
        let cartItem;
        $.ajax({
          url: url,
          method: 'GET',
      ...
      function clear_cart() {
        $.ajax({
          url: 'http://localhost:5001/api/v1/carts/2603b922-3fd5-4b0f-aa44-bd4cf20491e2',
          method: 'DELETE',
          dataType: 'json',
          success: function(response) {
	...
	$("#number--of--items").append(total_qty);
      ...
      function load_cart_items() {
        allItems(function(response) {
          ...
          jQuery.each(response, function(i, val) {
            ...
            row.append('<td><button class="increment">+</button></td>');
            row.append('<td><button class="decrement">-</button></td>');
